...
class SocialMediaLinkController extends Controller
{
    ...
    public function getData(Request $request)
    {
        ...
        return DataTables::of($socialMediaLinks)
            ->addColumn('action', function ($socialMediaLink) {
                return '<a href="'.route('vendor.social-media-links.edit', $socialMediaLink->id).'" class="btn btn-sm btn-primary">Edit</a>
                        <a href="'.route('vendor.social-media-links.destroy', $socialMediaLink->id).'" class="btn btn-sm btn-danger" 
    ...
    public function create()
    {
        ...
        return view('vendor.social-media-links.create', compact('languages'));
    }
    ...
    public function store(Request $request)
    {
        ...
        return redirect()->route('vendor.social-media-links.index')->with('success', __('cms.social_media_links.created'));
    }
    ...
    public function edit($id)
    {
        ...
        return view('vendor.social-media-links.edit', compact('socialMediaLink', 'languages', 'translations'));
    }
    ...
    public function update(Request $request, $id)
    {
        ...
        return redirect()->route('vendor.social-media-links.index')->with('success', __('cms.social_media_links.updated'));
    }
