                    ...
                    <div class="tab-content mt-3" id="languageTabContent">
                        @foreach($activeLanguages as $language)
                            ...
                            <div class="tab-pane fade show {{ $loop->first ? 'active' : '' }}" 
                                ...
                                <div id="image_preview_{{ $language->code }}" class="mt-2" style="{{ isset($translation->image_url) ? 'display: block;' : 'display: none;' }}">
                                    <img id="image_preview_img_{{ $language->code }}" src="{{ isset($translation->image_url) ? asset('storage/' . $translation->image_url) : '#' }}" 
