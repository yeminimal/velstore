...
return [
    ...
    'products' => [
        ...
        'select_product_type' => 'Produkttyp auswählen',
        'physical' => 'Physisch',
        'digital' => 'Digital',
        ...
        'status_updated' => 'Produktstatus erfolgreich aktualisiert!',
        'massage_confirm' => 'Löschbestätigung',
        'confirm_delete' => 'Sind Sie sicher, dass Sie dieses Produkt löschen möchten?',
        'massage_cancel' => 'Abbrechen',
        'massage_delete' => 'Löschen',
        'success' => 'Erfolg',
    ],
